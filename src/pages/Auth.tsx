    ...
    try {
      ...
      if (requiresTwoFactor !== undefined && tempToken) {
        ...
        if (loginType === "BUSINESS") {
          navigate(requiresTwoFactor ? "/business/2fa/login" : "/business/2fa/qr");
          return;
        }
      }
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Secure cross-border payment platform</p>
          </div>
                    ...
                    <Form>
                      <CardContent className="space-y-4">
                        ...
                        <div>
                          ...
                          <Select value={loginType} onValueChange={(v: LoginType) => setLoginType(v)}>
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="SUPER_USER">Business Admin Portal</SelectItem>
                              <SelectItem value="ADMIN">Exchange Admin Portal</SelectItem>
                              <SelectItem value="STAFF">Branch Portal/Staff(Login)</SelectItem>
                              <SelectItem value="BUSINESS">Business User Portal /Portal</SelectItem>
                            </SelectContent>
                          </Select>
