...
//       if (statusCode === 428 && responseData.requiresPasswordChange === true) {
//         const token = responseData.passwordChangeToken;
//         if (token) {
//           const maxAge = 60 * 60 * 4; // 4 hours – adjust according to your token expiry
//           setCookie("passwordChangeToken", token, { path: "/", maxAge });
//           setCookie("tempUserType", responseData.userType || "", { path: "/", maxAge });
//         }
