...
//             <p className="text-muted-foreground">Welcome back, Ahmed! Here's your KYB workload overview</p>
//           </div>
...
//                 </div>
//                 <div>
//                   <h2 className="text-2xl font-bold text-foreground">Dubai Mall Branch</h2>
//                   <p className="text-muted-foreground">Level 2, Dubai Mall, Downtown Dubai</p>
//                   <p className="text-sm text-muted-foreground mt-1">Branch Manager: Ahmed Hassan</p>
//                 </div>
//               </div>
...
const BranchDashboard = () => {
  ...
  const getPriorityColor = (priority?: string) => {
    ...
    return colors[priority.toLowerCase() as keyof typeof colors] || "border-l-orange-500";
  };
    ...
    <BranchLayout>
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Branch Dashboard</h1>
            <p className="text-muted-foreground">Welcome back, {cookies.fullName}! Here's your KYB workload overview</p>
          </div>
          {/* <div className="flex space-x-3">
            <Button variant="outline">
              <Calendar className="h-4 w-4 mr-2" />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-foreground">Dubai Mall Branch</h2>
                  <p className="text-muted-foreground">Level 2, Dubai Mall, Downtown Dubai</p>
                  <p className="text-sm text-muted-foreground mt-1">Branch Manager: {cookies.fullName}</p>
                </div>
              </div>
              {/* <div className="text-right">
                <div className="flex items-center gap-2 mb-2">
