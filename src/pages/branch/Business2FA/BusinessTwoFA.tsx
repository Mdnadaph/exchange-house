...
//         if (response.data.status) {
//           const { qrCodeUrl, manualEntryKey } = response.data.data;
//           setQrCodeUrl(qrCodeUrl);
//           setManualEntryKey(manualEntryKey);
//         } else {
//           setError(response.data.message || "Failed to initiate 2FA");
...
//         // 🔥 CLEAR OLD AUTH COOKIES (THIS IS THE KEY)
//         setCookie("token", "", { path: "/", maxAge: 0 });
//         setCookie("role", "", { path: "/", maxAge: 0 });
...
//           // ✅ FORCE BUSINESS ROLE
//           setCookie("role", "ROLE_BUSINESS", {
//             path: "/",
//             sameSite: "lax",
//           });

//           setCookie("businessTwoFactorEnabled", true, {
//             path: "/",
//           });
