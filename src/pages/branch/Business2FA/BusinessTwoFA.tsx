...
//           `${BASE_URL}/api/v3/business-auth/initiate-2fa-setup?email=${email}`
//         //   /api/v3/business-auth/initiate-2fa-setup?email=test@gmail.com
//         );
...
//         // /api/v3/business-auth/verify-2fa-setup
//         {
//           tempToken,
...
const BusinessTwoFA = () => {
  ...
  const email = cookies.businessEmail;
  const tempToken = cookies.businessTempToken;

  console.log("✅ BusinessTwoFA Cookies:", cookies);
  console.log("📧 Business Email:", email);
  console.log("🔑 Business TempToken:", tempToken);
