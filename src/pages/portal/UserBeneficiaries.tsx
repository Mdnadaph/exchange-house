...
const UserBeneficiaries = () => {
    ...
    try {
      ...
      if (response.data.status && response.data.data) {
        const mappedData = response.data.data.map((item: any) => ({
          id: `BEN-${item.id}`,
          name: item.name,
          type: item.type.toLowerCase() as "corporate" | "individual",
          email: "", // Add if API provides email
          ...
          registrationDate: "", // Add if API provides registration date
          documents: [], // Add if API provides documents
  ...
  // Handle create beneficiary (for form submission)
