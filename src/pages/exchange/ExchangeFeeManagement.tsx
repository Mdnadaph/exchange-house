...
const ExchangeFeeManagement = () => {
  ...
  const [data, setData] = useState<FeeApiResponse | null>(null);
  ...
  const fetchFeeRules = async () => {
    try {
      ...
      if (selectedType !== "all") params.transactioType = selectedType;
  ...
  return (
    <ExchangeLayout>
      <div className="space-y-6">
            ...
            <DialogContent className="max-w-xl">
              ...
              <div className="space-y-4 mt-4">
                ...
                <div>
                  ...
                  <Select
                    value={newFeeRule.country}
                    onValueChange={(v) =>
                      setNewFeeRule({ ...newFeeRule, country: v })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select country" />
        ...
        <Card>
          <CardHeader>
            <CardTitle>Fee Rules Configuration</CardTitle>
