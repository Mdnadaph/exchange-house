...
//  pending_review: "NOT_STARTED,PENDING,MANUAL_REVIEW,EDD_REQUIRED",
...
//        } else {
//          params.append("status", status); // fallback (should not happen now)
//        }
//      }
...
//            params.append("status", backendStatus);
//          } else {
//            params.append("status", status); // fallback for unexpected values
//          }
//        }
...
const ExchangeKYBReview = () => {
  ...
  useEffect(() => {
    fetchKYBApplications(currentPage, debouncedSearch, filterStatus);
