...
const ExchangeStaffManagement = () => {
      ...
      staff: [
        {
          ...
          name: "Ahmed Hassan", 
          role: "Branch Manager",
          email: "ahmed.hassan@businesspay.ae",
        ...
        },
        {
          ...
          name: "Priya Sharma",
          role: "KYB Officer",
          email: "priya.sharma@businesspay.ae", 
      ...
      staff: [
        {
          ...
          role: "Branch Manager",
          email: "fatima.alzahra@businesspay.ae",
        ...
        },
        {
          ...
          email: "omar.abdullah@businesspay.ae",
      ...
      staff: [
        {
          ...
          name: "Raj Patel",
          role: "Branch Manager",
          email: "raj.patel@businesspay.ae",
  ...
  const getStatusBadge = (status: string) => {
    const statusMap = {
      ...
      training: { variant: "destructive" as const, label: "Training", icon: Clock }
    };
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage branch staff and workload distribution</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="shadow-card">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Across 15 branches</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-card">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Pending KYB</CardTitle>
              <Clock className="h-5 w-5 text-warning" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">24</div>
              <p className="text-xs text-muted-foreground">Distributed across teams</p>
            </CardContent>
          </Card>
        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {branch.staff.map((staff) => {
                    ...
                    return (
                      <Card key={staff.id} className="border-l-4 border-l-accent hover:shadow-md transition-smooth">
                        <CardContent className="p-6">
                            ...
                            <div className="space-y-4 flex-1">
                              ...
                              <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-muted-foreground">ID: {staff.id}</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm bg-muted/30 rounded-lg p-4">
                                ...
                                <div className="space-y-1">
                                  ...
                                  <p className="text-xs">
                                    {Math.round((new Date().getTime() - new Date(staff.joinDate).getTime()) / (1000 * 60 * 60 * 24 * 30))} months
                                  </p>
                                </div>
                                <div className="space-y-1">
                                  <span className="text-muted-foreground">KYB Workload:</span>
                                  <p className="font-medium">{staff.kybAssigned} assigned</p>
                                  <p className="text-xs">{staff.kybCompleted} completed total</p>
                                </div>
                                <div className="space-y-1">
                                  <span className="text-muted-foreground">Efficiency:</span>
                                  <p className={`font-medium ${getEfficiencyColor(staff.efficiency)}`}>
                                    {staff.efficiency}%
                                  </p>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                <div className="text-center p-3 bg-success/10 rounded-lg">
                                  <p className="font-semibold text-success text-lg">{staff.kybCompleted}</p>
                                  <p className="text-xs text-muted-foreground">Total KYB Completed</p>
                                </div>
                                <div className="text-center p-3 bg-warning/10 rounded-lg">
                                  <p className="font-semibold text-warning text-lg">{staff.kybAssigned}</p>
                                  <p className="text-xs text-muted-foreground">Currently Assigned</p>
                                </div>
                                <div className="text-center p-3 bg-primary/10 rounded-lg">
                                  <p className={`font-semibold text-lg ${getEfficiencyColor(staff.efficiency)}`}>
                                    {staff.efficiency}%
                                  </p>
