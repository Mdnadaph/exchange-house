    ...
    <ExchangeLayout>
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Deal Requests Review</h1>
            <p className="text-muted-foreground">Review and respond to custom exchange rate requests</p>
          </div>
        </div>
