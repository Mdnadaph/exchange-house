...
import BusinessTwoFA from "./pages/branch/Business2FA/BusinessTwoFA";
import BusinessVerifyTwoFALogin from "./pages/branch/Business2FA/BusinessVerifyTwoFALogin";
import UserSetupPassword from "./pages/portal/BusinessUser/UserSetupPassword";
...
const ProtectedRoute = ({ allowedRoles }: ProtectedRouteProps) => {
  ...
  // if (currentRole === "ROLE_BUSINESS_USER") {
  //   return <Navigate to="/portal" replace />;
  // }
          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/business-user-set-password" element={<UserSetupPassword />} />
                <Route path="/business-user-generateqr" element={<UserTwoFA />} />
                <Route path="/business-user-2fa-login" element={<UserTwoFALogin />} />
