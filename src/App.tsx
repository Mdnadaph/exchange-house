...
// // ─── Protected Route with Role + Redirect Logic ───────────────────────────
...
//   // 2. Explicitly allowed for this section
//   if (allowedRoles.includes(currentRole)) {
//     return <Outlet />;
//   }

//   // 3. Smart redirects based on role (fallback)
...
//   // 4. Unknown role → login (safety net)
...
//                     <ProtectedRoute
//                       allowedRoles={[
//                         "ROLE_SUPER_USER" /* ← adjust real roles */,
//                       ]}
//                     />
//                   }
//                 >
...
//                 {/* Portal – regular staff / users */}
//                 <Route
//                   element={
//                     <ProtectedRoute
//                       allowedRoles={["ROLE_BUSINESS_ADMIN" /* ← adjust */]}
//                     />
//                   }
//                 >
//                   <Route path="/portal">
...
//                   element={
//                     <ProtectedRoute
//                       allowedRoles={BRANCH_ROLES.filter(
//                         r => !["ROLE_KYB_OFFICER", "ROLE_SENIOR_KYB_OFFICER", "ROLE_BRANCH_MANAGER", "ROLE_STAFF"]
//                           .includes(r)
//                       )}
//                     />
//                   }
