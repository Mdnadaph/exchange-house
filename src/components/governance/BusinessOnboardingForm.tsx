...
//       const response = await axios.post(`${BASE_URL}/api/v3/business/onboard`, apiFormData, {
//         headers: {
...
//           description: response.data.message || "An error occurred during onboarding.",
//           variant: "destructive",
//         });
//       }
//     } catch (error) {
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="registeredBranch">Registered Branch *</Label>
              <Select
                value={formData.registeredBranch}
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, registeredBranch: value }))
                }
              >
                <SelectTrigger>
                  <SelectValue
